...
| 4 | `python -m outros.novos_eleitos.e4_pre_mapeamento --publicar` | depois de 1 a 3 | Reeleição, volta ou novo, e a origem de cada candidatura. Confere a reeleição contra o Radar |
| 5 | `python -m outros.novos_eleitos.e5_eleitos --ciclo ele2026 --publicar` | quando a totalização fechar | Eleitos por `sqcand`, com a classificação da etapa 4. Teste antes da urna: `--ciclo ele2022` |
